...
function DoctorDashboard(props) {
  ...
  const handleCC = (e) => {
    ...
    formData.append("AccountNo", ccAccountNo);
  ...
  const handleMbbs = (e) => {
    ...
    formData.append("mbbsCertificate", mbbsCertificate);
    formData.append("name", filename);
    formData.append("url", filePath);
    axios
      .post("http://localhost:8090/api/documents/uploadOne", formData)
                ...
                <Card.Body style={bodyStyle}>
                  <Table style={{ width: "100%" }} borderless>
                    ...
                    <tbody>
                          ...
                          <Row>
                            ...
                            <Col md={12}>
                              <input
                                type="text"
                                value={ccAccountNo}
                                onChange={(e) => setccAccountNo(e.target.value)}
                                className="form-control"
                      ...
                      >
                        ...
                        <td>
                          <input
                            ...
                            onChange={(e) => setmbbsCertificate(e.target.value)}
                            id="resume"
                            name="resume"
                            className="form-control"
                            disabled={!mbbs}
                      ...
                      >
                        <td>12.</td>
                        <td id="BankStatement">Bank Statement for 6 months</td>
                        <td>
                          <input
                            type="text"
                            id="aad-num"
