...
function Dashboard({ reqTableData, history }) {
  ...
  useEffect(() => {
    axios.get("http://localhost:8090/api/doctor/").then((res) => {
      console.log(res.data, "newRecord");
                  ...
                  <div className="col-xl-8 col-md-8">
                    <div className="card ht-xs-90p" style={infoStyle}>
                      ...
                      <ChartComponent1
                        datalist={
                          dashBoardCount &&
                          dashBoardCount.data2 &&
                          dashBoardCount.data2.length
                        }
                      />
                    </div>
                  </div>
